    ...
    /*
        private fun initListeners(){
            ...
            binding.btnSearch.setOnClickListener{
                userFragmentViewModel.onSearchSelected(binding.etUserMail.text.toString())
            }
        ...
        private fun initObservers(){
            ...
            userFragmentViewModel.searchUser.observe(viewLifecycleOwner){
                    res -> if(res!=null) {
            ...
            userFragmentViewModel.modifyUser.observe(viewLifecycleOwner){
                    res -> if(res!=null) showSucces()
            else showAlert()
            }


            userFragmentViewModel.deleteUser.observe(viewLifecycleOwner){
                    res -> if(res) showSucces()
            else showAlert()
            }
